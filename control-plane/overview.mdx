...
WireSocket uses a standard **OAuth 2 Machine-to-Machine (M2M)** flow. Your backend server exchanges its App credentials for a token, which is then passed to your collaborative clients.
