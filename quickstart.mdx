...
Open your app from the **Apps** list and go to the **Plans** tab. Your first app is on the **Free plan** automatically. For additional apps, subscribe to a paid plan to activate dataplane access.

<Info>
  The Free plan includes 40 concurrent connections, 10 documents, 3 users per document, and 500 operations per minute — enough to get started.
</Info>
